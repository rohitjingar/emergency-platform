  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">Monitor and manage the emergency platform</p>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-4 mb-8">
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats?.total_incidents || 0}</p>
        ...
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats?.needs_review || 0}</p>
        ...
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats?.override_rate_percent?.toFixed(1) || 0}%</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Override Rate</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <Card title="System Health">
          ...
          {health?.issues?.length > 0 && (
            <div className="mt-4 p-3 bg-red-50 border border-red-200 dark:border-gray-700 rounded-lg">
        ...
        <Card title="AI Performance">
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-gray-600 dark:text-gray-400">Override Rate</span>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">{stats?.needs_review || 0} pending</p>
              </div>
            </div>
          </Card>
        </Link>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">View all services</p>
              </div>
            </div>
          </Card>
        </Link>
        ...
        <Card>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Admin tools</p>
            </div>
          </div>
        </Card>
      </div>
